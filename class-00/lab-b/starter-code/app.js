...
let objectLit = array => ({ key1: array[0], key2: array[1], key3: array[2]});

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objectLit(['hi', 'hola', 'hai']));
...
// the object Student w/ properties nonsensically assigned (hometown 100, age schmoe) from the starter code
// 2. What is "this" when joe.scopeArrow() is invoked?
// the window because its the next scope available
// 3. Explain why "this" is different when an arrow function is used.
// when you call "this" on an arrow function the scope is the object the object is in.  One level up.
// I think this question is written badly and needs to complete the thought/point- different compared to what? earlier questions? when used in a object as in .scope()?
